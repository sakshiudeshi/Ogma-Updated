...
# src = "DataFiles/MasterData/"+ folder_type + "/"
    ...
    fig.suptitle('Errors in Sentiment analysis for\n' + folder_type)
    ...
    if folder == "MasterData Positive Start":
        ...
        os.chdir("/Users/sakshiudeshi/Documents/SUTD/Research/Grammar ML/Sentiment Analysis/figs/master-error-start")
